...
<%= _.template($('#input_constructor').html())({id:"CellAddress", description: tr("Cell address"), default_selector: "string", disable_int:true, value_string: "", help: {description: tr("Cell address in excel file. You can specify a standard address with a column letter and row number, or the column number and row number separated by *."),examples:[{code:"A1", description: tr("First column, first row")}, {code:"B2", description: tr("Second column, second row")}, {code:tr("1*1"), description: tr("Analog") + " A1. " + tr("First column, first row")}, {code:tr("2*2"), description: tr("Analog") + " B2. " + tr("Second column, second row")}]} }) %>
<%= _.template($('#input_constructor').html())({id:"Data", description: tr("Data"), default_selector: "string", disable_int:true, value_string: "", help: {description: tr("The data which needs to be written to the specified cell.")} }) %>
</div>
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Write data to a cell in an excel file.</div>
