...
window.SearchFilter = {
  ...
  template: /*html*/ `
    <div v-show="visible" class="app-search">
      <input ref="input" type="text" class="app-search-input" spellcheck="false" :value="value" :disabled="disabled" :placeholder="$t('search.placeholder')" @input="$emit('input', $event.target.value)" @keydown.esc="clear">
