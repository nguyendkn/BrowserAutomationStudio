...
<%= _.template($('#input_constructor').html())({id:"Data", description: tr("Data"), default_selector: "string", disable_int:true, value_string: "", help: {description: tr("The data which needs to be written to the specified sheet.") + " " + tr("You can write strings, numbers, booleans and dates to a cell. Numbers and booleans can be specified as a string and they will be automatically converted to the correct type, and dates are perceived only as a javascript date object. When writing the date, the numberFormat style is automatically set to the cell for correct display in excel."),examples:[{code:"[\"A1:B1:C1\",\"A2:B2:C2\",\"A3:B3:C3\"]", description:"CSV list"},{code:"A1:B1:C1\nA2:B2:C2\nA3:B3:C3", description:"CSV string"},{code:"[[\"A1\",\"B1\",\"C1\"],[\"A2\",\"B2\",\"C2\"],[\"A3\",\"B3\",\"C3\"]]", description:"2D list"},{code:tr("\"I'm just an example text\""), description: tr("String")}, {code:289, description: tr("Integer")}, {code:0.4494634651211913, description: tr("Floating point number")}, {code:true, description: tr("Boolean")}, {code:new Date(), description: tr("The date object will be automatically converted to a number and the cell will be set style numberFormat")}, {code:"\"289\"", description: tr("String which will be automatically converted to an integer") + " <code>289</code>"}, {code:"\"0.619234167732591\"", description: tr("String which will be automatically converted to floating point number") + " <code>0.619234167732591</code>"}, {code:"\"false\"", description: tr("String which will be automatically converted to boolean") + " <code>false</code>"}]} }) %>
</div>
