...
<div class="tooltipinternal">
  ...
  <div class="tr tooltip-paragraph-fold">This action does not require you to search for the necessary information to solve the <code>HCaptcha</code> manually, everything happens automatically without your interaction using the source code of the page and other data. Exceptions are optional parameters, such as the use of proxies and the User-Agent.</div>
