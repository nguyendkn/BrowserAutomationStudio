(function (api) {
  const errors = {
    ...
    ERROR_WRONG_GOOGLEKEY: {
      ru: "Параметр googlekey отсутствует в вашем запросе.",
      en: "googlekey parameter is missing in your request"
    },
    ...
    TOO_MANY_BAD_IMAGES: {
      ru: "Вы присылаете слишком много изображений, которые невозможно распознать",
      en: "You are sending too many unrecognizable images"
    },
    MAX_USER_TURN: {
