...
<%= _.template($('#input_constructor').html())({id:"FilePath", description: tr("File path"), default_selector: "string", disable_int:true, value_string: "", help: {description:tr("The path to the excel file which needs to be synchronized with resources."),examples:[{code:"C:/test.xlsx"},{code:"C:/Program Files/test1.xlsx"},{code:"C:/Program Files/test2.xlsx"}]} }) %>
...
<div class="tooltipinternal">
      <div class="tr tooltip-paragraph-first-fold">Synchronize excel file and resources.</div>
	  <div class="tr tooltip-paragraph-fold">This action creates a resource from each sheet of the excel file that has the name of the sheet and its contents.</div>
