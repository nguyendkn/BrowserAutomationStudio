...
std::string IPCSimple::Init(const std::string& IdDefault)
{
    ...
    Data = (unsigned char *)MapViewOfFile(MappingHandler, FILE_MAP_ALL_ACCESS,0,0,2048);
...
bool IPCSimple::Write(const std::string Id, const std::string& Message)
{
    ...
    //Map
    unsigned char *Data = (unsigned char *)MapViewOfFile(MappingHandler, FILE_MAP_ALL_ACCESS,0,0,2048);
