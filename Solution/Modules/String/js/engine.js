...
function _concat_strings(string1, string2, string3, strings_list, separator){
	return [_avoid_nil(string1), _avoid_nil(string2), _avoid_nil(string3)].concat(_convert_to_list(_avoid_nil(strings_list))).join(_avoid_nil(separator));
};
function _get_latin_character(character){
