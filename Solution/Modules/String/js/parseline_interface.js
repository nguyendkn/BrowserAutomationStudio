...
<%= _.template($('#input_constructor').html())({id:"Value", description: tr("String"), default_selector: "string", disable_int:true, value_string: "", help: {description: tr("CSV string with want to parse into items."),examples:[{code:"login:password"},{code:"id,name,login"},{code:tr("Just sample text") + ";Test text;string"}]} }) %>
