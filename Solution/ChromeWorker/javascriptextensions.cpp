...
std::string JavaScriptExtensions::GetBasicExtension(bool IsRecord)
{
    ...
    if(IsRecord)
    {
        ...
        "{"
            ...
            "if(el){"
                ...
                "}"
                "label += css;"
                "return [parseInt(rect.left),parseInt(rect.top),parseInt(rect.width),parseInt(rect.height),label,css,css2,css3,match,xpath,x + document.scrollingElement.scrollLeft,y + document.scrollingElement.scrollTop,true,is_frame,frame_element,x_with_padding,y_with_padding,position];"
            "}else{"
    ...
    "{"
        "try{"
            ...
            "if(x > document.scrollingElement.scrollLeft && x < document.scrollingElement.scrollLeft + window.innerWidth && y > document.scrollingElement.scrollTop && y < document.scrollingElement.scrollTop + window.innerHeight)"
            "{"
                "var res = document.scrollingElement.scrollLeft + ',' + document.scrollingElement.scrollTop + ',' + x.toString() + ',' + y.toString();"
                "return res;"
                "return;"
            "}"
            ...
            "{"
                "document.scrollingElement.scrollLeft = x - window.innerWidth/2;"
            "}"
            "if(typeof(allowoutofbounds) == 'undefined' || !allowoutofbounds || y >= 0)"
            "{"
                "document.scrollingElement.scrollTop = y - window.innerHeight/2;"
            "}"
        "}catch(e)"
        "{"
        ...
        "try{"
            ...
            "{"
                ...
                "{"
                    ...
                    "res = document.elementFromPoint(x - document.scrollingElement.scrollLeft,y - document.scrollingElement.scrollTop);"
                "}"
                "if(!res)"
                    "return null;"
            "}"
