<div class="container-fluid">
    <%= _.template($('#variable_constructor').html())({id:"Save", description:tr("Variable to save the result"), default_variable: "EXECUTABLE_DIRECTORY", help: {description: tr("Variable in which, after successful execution of the action, the path to the project file will be written."), examples:[{code:"C:/BrowserAutomationStudio/apps/24.0.8",description:tr("Not compiled script")},{code:"D:/Gparser/appslocal/ibq8y9qo/SID/engine",description:tr("Unprotected compiled script")},{code:"D:/Gparser/appsremote/Gparser/SID/engine",description:tr("Protected compiled script")}]}}) %>
</div>
<div class="tooltipinternal">
    <div class="tr tooltip-paragraph-first-fold">Get the full path to the executable directory.</div>
