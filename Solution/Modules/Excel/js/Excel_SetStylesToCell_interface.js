...
<%= _.template($('#input_constructor').html())({id:"FilePath", description: tr("File path"), default_selector: "string", disable_int:true, value_string: "", help: {description:tr("The path to the excel file where for the cell needs to set the styles."),examples:[{code:"C:/test.xlsx"},{code:"C:/Program Files/test1.xlsx"},{code:"C:/Program Files/test2.xlsx"}]} }) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Set styles values for cell of excel file.</div>
