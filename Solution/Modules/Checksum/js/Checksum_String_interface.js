<div class="container-fluid">
	...
	<%= _.template($('#input_constructor').html())({
		...
		default_selector: "string",
		variants: [
			{value:"crc16", description:"Cyclic Redundancy Check - 16-" + tr("bit hashing algorithm")},
			{value:"crc32", description:"Cyclic Redundancy Check - 32-" + tr("bit hashing algorithm")},
			{value:"md4", description:"Message Digest 4 - 128-" + tr("bit hashing algorithm")},
			{value:"md5", description:"Message Digest 5 - 128-" + tr("bit hashing algorithm")},
			{value:"mdc2", description:"Modification Detection Code 2 - 128-" + tr("bit hashing algorithm")},
			{value:"ripemd160", description:"RACE Integrity Primitives Evaluation Message Digest - 160-" + tr("bit hashing algorithm")},
			{value:"whirlpool", description:"Whirlpool - 512-" + tr("bit hashing algorithm")},
			{value:"sha1", description:"Secure Hash Algorithm 1 - 160-" + tr("bit hashing algorithm")},
			{value:"sha224", description:"Secure Hash Algorithm 2 - 224-" + tr("bit hashing algorithm")},
			{value:"sha256", description:"Secure Hash Algorithm 2 - 256-" + tr("bit hashing algorithm")},
			{value:"sha384", description:"Secure Hash Algorithm 2 - 384-" + tr("bit hashing algorithm")},
			{value:"sha512", description:"Secure Hash Algorithm 2 - 512-" + tr("bit hashing algorithm")},
			...
			{value:"shake128", description:"Secure Hash Algorithm 3 - 128-" + tr("bit hashing algorithm") + " " + tr("with extendable result")},
			{value:"shake256", description:"Secure Hash Algorithm 3 - 256-" + tr("bit hashing algorithm") + " " + tr("with extendable result")},
			{value:"keccak224", description:"Keccak - 224-" + tr("bit hashing algorithm")},
			{value:"keccak256", description:"Keccak - 256-" + tr("bit hashing algorithm")},
			{value:"keccak384", description:"Keccak - 384-" + tr("bit hashing algorithm")},
			{value:"keccak512", description:"Keccak - 512-" + tr("bit hashing algorithm")},
			{value:"blake2b512", description:"Blake 2b - 512-" + tr("bit hashing algorithm")},
			{value:"blake2s256", description:"Blake 2s - 256-" + tr("bit hashing algorithm")},
		...
		help: {
			...
			examples: [
				...
				{code:"sha512", description:"Secure Hash Algorithm 2 - 512-" + tr("bit hashing algorithm")},
				{code:"keccak512", description:"Keccak - 512-" + tr("bit hashing algorithm")},
	...
	<%= _.template($('#block_start').html())({id:"Additional", name: tr("Additional settings"), description: ""}) %>
		<span data-preserve="true" data-preserve-type="check" data-preserve-id="Check">
			<input type="checkbox" id="Check" style="margin-left:25px" onclick="set_encoding_visible()"/> <label for="Check" class="tr">String is base64 encoded</label>
		</span>
		<%= _.template($('#input_constructor').html())({
			id: "inputEncoding",
			description: tr("String encoding"),
			default_selector: "string",
			variants: [
				"utf-8",
				"utf-16le",
			...
			value_string: "utf-8",
			help: {
				description: tr("The encoding of the specified string."),
				examples: [
					{code: "utf-8"},
					{code: "ascii"},
					{code: "hex"},
		...
		<%= _.template($('#input_constructor').html())({
			...
			max_number: 999999,
			help: {
				description: tr("Optional parameter.") + " " + tr("The length of the raw checksum, used only for <code style=\"font-size:85%\">shake</code> algorithms."),
				examples: [
	...
	<%= _.template($('#variable_constructor').html())({
		...
		help: {
			...
			examples: [
				{code: "3610a686", description: "<code style=\"font-size:85%\">crc32</code> - <code style=\"font-size:85%\">hex encoded</code>"},
				...
				{code: "RVJOxFS8x9S490NQxKTmKAn8tJvCnfYuYbafpA==", description: "<code style=\"font-size:85%\">keccak224</code> - <code style=\"font-size:85%\">base64 encoded</code>"}
			]
		}
	}) %>
</div>
<div class="tooltipinternal">
	...
	<div class="tr tooltip-paragraph-fold">For the same data, the checksum will always be the same, and if the data is the slightest difference, the checksum will be different.</div>
	...
	<div class="tr tooltip-paragraph-fold">Checksum formats:</div>
	...
	<div class="tr tooltip-paragraph-fold">String encoding can be specified using the "String encoding" parameter located in the additional settings.</div>
	<div class="tr tooltip-paragraph-fold">If the string is encoded in base64, then for correct calculation of the checksum, activate the "String is base64 encoded" parameter located in the additional settings.</div>
	<div class="tr tooltip-paragraph-fold">For <code>shake</code> algorithms, you can specify the length of the raw checksum by filling in the "Result length" parameter located in the additional settings.</div>
	...
	<div class="tr tooltip-paragraph-fold">Algorithms <code>sha256</code> and <code>sha512</code> are compatible with the NaCl and Sodium libraries.</div>
