...
<%= _.template($('#input_constructor').html())({id:"number", description: tr("Number"), default_selector: "string", value_string: "", help: {description: tr("The number by which the declension of the returned word will be determined."),examples:[{code:123},{code:100000},{code:1456.578}]} }) %>
