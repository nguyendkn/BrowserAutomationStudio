  ...
  <div id="modalDialogContainer">
    ...
    <div id="modalContentContainer">
      <div id="modalListContainer">
                ...
                <ul class="modal-list-items">
                  <% map[header].forEach((item) => { %>
                    <li class="modal-list-item" data-id="<%= item.id %>">
                      <div class="modal-list-text-normal modal-text-nowrap modal-text-<%= metadata.color %>"><%= metadata.template(item) %></div>
                      <% if (item.action) { %>
                        <div class="modal-list-item-content">
                          ...
                          <div class="modal-list-text-small modal-text-nowrap modal-text-gray"><%= item.action.description %></div>
                        </div>
                      <% } %>
                    </li>
                  <% }); %>
        ...
        <div class="modal-list-empty"><%= tr('No variables found') %></div>
      </div>
      <div id="modalRecentContainer">
        <div id="modalRecentHeader">
          <div id="modalRecentHeaderText">Recent <%= metadata.pluralName %>:</div>
            ...
            <% recent.forEach((item) => { %>
              <li class="modal-recent-wrap">
                <div class="modal-recent-item" data-id="<%= items.find(({ name }) => name === item.name).id %>">
                  ...
                  <div class="modal-recent-text modal-text-nowrap modal-text-<%= metadata.color %>"><%= item.name %></div>
