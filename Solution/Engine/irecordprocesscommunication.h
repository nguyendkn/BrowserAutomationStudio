...
namespace BrowserAutomationStudioFramework
{
    ...
    public slots:
        ...
        virtual void SendCode(const QString& Code,const QString& Schema, const QString& EmbeddedLanguageData, bool IsTesting, const QString& ScriptEngineVersion, const QString& ApplicationEngineVersion, const QString& InterfaceState) = 0;
