<%= variable %> = _normalize_url(<%= url %>, {
	base_url: <%= base_url %>,
	default_protocol: <%= default_protocol.slice(-2)==':"' ? default_protocol : (default_protocol.slice(0, -1) + ':"') %>,
	...
	remove_directory_index: <%= remove_directory_index %>,
