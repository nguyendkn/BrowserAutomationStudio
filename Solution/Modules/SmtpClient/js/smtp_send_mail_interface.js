<div class="container-fluid">
    ...
    <%= _.template($('#input_constructor').html())({id:"Subject", description:tr("Subject. Can be blank."), default_selector: "string", disable_int:true}) %>
	...
	<span data-preserve="true" data-preserve-type="check" data-preserve-id="Check">
		<div><input type="checkbox" id="Check"/> <label for="Check" class="tr">Send as HTML</label></div>
	</span>
