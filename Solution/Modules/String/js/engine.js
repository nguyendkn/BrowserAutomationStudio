...
function _words(str){
    ...
    return _avoid_nil(_clean(str).replace(/[\-]{2,}/g, " ").match(/[A-ZА-ЯЁ\xC0-\xD6\xD8-\xDE\-]+(?![a-zа-яё\xDF-\xF6\xF8-\xFF\-\d])|[A-ZА-ЯЁ\xC0-\xD6\xD8-\xDE\-]?[a-zа-яё\xDF-\xF6\xF8-\xFF\-\d]+/g), []).filter(function(s){return /([^\-]+)/.test(s)}).map(function(s){return _trim(s, _STR_WHITESPACE + _STR_SPECCHARS + "-")});
};
...
function _clean(str, chars_to_delete, chars_to_space, multiple_spaces){
	...
	chars_to_delete = _avoid_nil(chars_to_delete, '\\f\\t\\v');
...
function _ua(uastring, extensions){
	...
	ua = _trim(ua, "\\x09\\x0A\\x0B\\x0C\\x0D\\x20\\xA0\\u1680\\u180E\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200A\\u202F\\u205F\\u3000\\u2028\\u2029\\uFEFF");
