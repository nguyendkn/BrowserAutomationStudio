...
<%= _.template($('#input_constructor').html())({id:"Mask", description:tr("File/Folder name mask"), default_selector: "string", disable_int:true, value_string: "*", help: {description: tr("File/Folder name mask for filtering. The final list will include only files/folders whose names match the mask."),examples:[{code:tr("*.js"), description: tr("All JavaScript files")},{code:tr("*.txt"), description: tr("All text files")},{code:tr("*"), description: tr("All files")}]} }) %>
<div>
