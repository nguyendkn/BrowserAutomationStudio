...
<div class="tooltipinternal">
	...
	<div class="tr tooltip-paragraph-fold">If the archive is incorrect format or an error occurred while execute action, the thread will stop with fail message. If you want to continue thread, use "Ignore errors" action.</div>
