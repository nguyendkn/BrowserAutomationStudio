...
<div class="tooltipinternal">
	...
	<div class="tr tooltip-paragraph-fold">This action will return a string in which the first letter will be uppercase, and the rest will remain unchanged or will be lowercase.</div>
	...
	<div class="tr tooltip-paragraph-last-fold">If the "All other letters in lowercase" parameter is enabled, then all letters that were not converted to uppercase will be converted to lowercase.</div>
</div>
