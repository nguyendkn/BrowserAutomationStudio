...
<%= _.template($('#input_constructor').html())({id:"decimals", description:tr("Number of decimal places"), default_selector: "int", disable_string:true, value_number: -1, min_number:-1, max_number:20, help: {description: tr("Optional parameter.") + " " + tr("The number of decimal places to which the number will be rounded."),examples:[{code:4, description:156.6439},{code:2, description:21.78},{code:0, description:tr("Round to whole number")},{code:-1, description:tr("Do not round the number")},{code:tr("Empty string"), description:tr("Do not round the number")}]} }) %>
