...
<%= _.template($('#input_constructor').html())({id:"DestinationPath", description:tr("Destination path") + ". " + tr("Can be blank"), default_selector: "string", disable_int:true, value_string: "", help: {description:tr("The path to the location where the archive will be saved."),examples:[{code:"C:/test.zip"},{code:"D:\\test\\archive.rar"},{code:"C:/Program Files/test.7z"},{code:tr("Empty string"), description: tr("Place archive next to the original folder")}]} }) %>
</div>
<div class="tooltipinternal">
	...
	<div class="tr tooltip-paragraph-fold">If a non-existent destination path is specified, it will be created provided that an existing disk is specified.</div>
	<div class="tr tooltip-paragraph-fold">If such an archive already exists along the destination path, it will be overwritten.</div>
