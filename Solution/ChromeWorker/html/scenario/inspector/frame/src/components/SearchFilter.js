...
window.SearchFilter = {
  ...
  template: /*html*/ `
    <div class="app-search">
      <input :value="query" :disabled="!search" :placeholder="$t('search.placeholder')" class="app-search-input" spellcheck="false" type="text" @input="$emit('input', $event.target.value)" @keydown.esc="$emit('input', '')">
