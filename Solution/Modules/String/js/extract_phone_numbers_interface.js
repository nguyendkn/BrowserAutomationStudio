...
<%= _.template($('#input_constructor').html())({id:"string", description: tr("String"), default_selector: "string", value_string: "", help: {description: tr("The string from which to extract phone numbers."),examples:[{code:tr("Hello, my number is +1 323 123-4567")},{code:tr("</br>Business enquiries/press: Alexandra +7 900 000-00-00")},{code:tr("</br>PR: Maria +7(900)000-00-01 | Agent 1: Valeria +7(900)000-00-02 | Agent 2: Ekaterina +7(900)00-00-03")}]} }) %>
