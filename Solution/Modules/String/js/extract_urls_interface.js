...
<%= _.template($('#input_constructor').html())({id:"string", description: tr("String"), default_selector: "string", value_string: "", help: {description: tr("The string from which to extract links."),examples:[{code:tr("You can buy the product by the link - https://marketplace.biz/section_3/product_213234.php")},{code:tr("</br>Test text http://test.com, string test example.org")},{code:tr("</br>Ad -> http://www.ad.by/info, feedback -> www.feedback.io, support -> https://support.co/new/ticket.php")}]} }) %>
