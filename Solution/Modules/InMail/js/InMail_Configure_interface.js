...
<div class="tooltipinternal">
	...
	<div class="tr tooltip-paragraph-fold">This action should be called once before any other action that works with the mail server.</div>
	...
	<div class="tooltip-paragraph-fold"><span class="tr">For most mail services, you also need to allow imap/pop3 access in your account settings. Here are</span> <a href="#" class="tr" onclick="BrowserAutomationStudio_OpenUrl('https://support.google.com/mail/answer/7126229?hl=en');return false">settings</a> <span class="tr">for gmail</span>. <span class="tr">Also, the mail service may have a separate password for connecting via imap/pop3.</span></div>
