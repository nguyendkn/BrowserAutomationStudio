...
<%= _.template($('#variable_constructor').html())({id:"Save", description:tr("Variable to save the result"), default_variable: "SQL_RECORD_LIST", help: {description: tr("Variable in which, after successful execution of the action, the received records will be written.") + " " + tr("The format of the saved data depends on the \"Data Format\" setting.")}}) %>
