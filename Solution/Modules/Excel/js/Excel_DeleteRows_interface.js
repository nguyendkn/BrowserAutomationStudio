...
<%= _.template($('#input_constructor').html())({id:"FilePath", description: tr("File path"), default_selector: "string", disable_int:true, value_string: "", help: {description:tr("The path to the excel file from which needs to remove the rows."),examples:[{code:"C:/test.xlsx"},{code:"C:/Program Files/test1.xlsx"},{code:"C:/Program Files/test2.xlsx"}]} }) %>
...
<%= _.template($('#input_constructor').html())({id:"FromRow", description: tr("From row") + ". " + tr("Can be blank"), default_selector: "int", disable_string:true, value_number: "", min_number:-1, max_number:999999, help: {description: tr("Row index from which deleting starts."),examples:[{code:-1, description:tr("Last row")},{code:0, description:tr("First row")},{code:1, description:tr("Second row")},{code:tr("Empty string"), description: tr("First row")}]} }) %>
<%= _.template($('#input_constructor').html())({id:"ToRow", description: tr("To row") + ". " + tr("Can be blank"), default_selector: "int", disable_string:true, value_number: "", min_number:-1, max_number:999999, help: {description: tr("Row index after which deleting ends."),examples:[{code:-1, description:tr("Last row")},{code:0, description:tr("First row")},{code:1, description:tr("Second row")},{code:tr("Empty string"), description: tr("Last row")}]} }) %>
</div>
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Delete rows from specified sheet of excel file.</div>
	<div class="tr tooltip-paragraph-fold">Rows following the deleted rows will be shifted up.</div>
	<div class="tr tooltip-paragraph-fold">Deletion is performed from a row to and including a row, to delete one row, you need to specify its index in both parameters.</div>
