...
<%= _.template($('#input_constructor').html())({id:"path", description: tr("Path"), default_selector: "string", value_string: "", help: {description: tr("The path from which to get the extension."),examples:[{code:"/home/user/dir/file.txt"},{code:"D:/dev/sql/sqlite/your.db"},{code:"C:/Users/Admin/Desktop/site/index.html"}]} }) %>
