...
<%= _.template($('#input_constructor').html())({id:"Protocol", description:tr("Protocol"), default_selector: "string", variants:["FTP","SFTP","SSH<br/><span style='color:gray;font-size:small'>(SCP)</span>"], disable_int:true, value_string: "FTP", help: {description: tr("The protocol by which the connection to the remote server will be made.")} }) %>
...
<%= _.template($('#input_constructor').html())({id:"Port", description:tr("Port"), default_selector: "string", disable_int:true, value_string: "21", help: {description: tr("Port of the remote server."),examples:[{code:"21",description:tr("Default port for FTP protocol")},{code:"22",description:tr("Default port for SFTP and SSH protocols")}]} }) %>
