...
<%= _.template($('#input_constructor').html())({id:"path", description: tr("Path"), default_selector: "string", value_string: "", help: {description: tr("The path from which to get the directory."),examples:[{code:"/foo/bar/baz/asdf/quux"},{code:"D:/modules/res/panels/panel3.jpg"},{code:"C:/Users/Admin/Desktop/projects/project.xml"}]} }) %>
