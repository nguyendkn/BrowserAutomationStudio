...
<%= _.template($('#input_constructor').html())({id:"FilePath", description:tr("Remote file path"), default_selector: "string", disable_int:true, value_string: "", help: {description:tr("The path to the file on the remote server, the checksum of which needs to get."),examples:[{code:"/html/test/index.html"},{code:"/public_html/test1.js"},{code:"/domains/site.com/public_html/test2.txt"}]} }) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Get the checksum of the file located on the remote server and save it to a variable.</div>
	...
	<div class="tooltip-paragraph-fold"><span class="tr">For this action to work, sha1sum must be installed on the server. Learn more about sha1sum</span> <a href="#" class="tr" onclick="BrowserAutomationStudio_OpenUrl('https://en.wikipedia.org/wiki/Sha1sum');return false">here</a><span>.</span></div>
