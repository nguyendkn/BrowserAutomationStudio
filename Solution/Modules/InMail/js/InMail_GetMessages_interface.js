<div class="container-fluid">
	...
	<%= _.template($('#block_start').html())({id:"Parsing", name: tr("Parsing"), description: ""}) %>
		...
		<span data-preserve="true" data-preserve-type="check" data-preserve-id="attachments">
			<input type="checkbox" id="attachments" style="margin-left:25px"/> <label for="attachments" class="tr">Attachments</label> <i class="fa fa-question-circle help-input" data-toggle="tooltip" data-html="true" title="<%= _.escape(_.template($("#tooltip-input").html())({title: tr("Attachments"), description: tr("Attachments")})) %>"></i>
		</span>
