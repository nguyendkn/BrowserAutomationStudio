...
<%= _.template($('#input_constructor').html())({id:"Command", description:tr("Command"), default_selector: "string", disable_int:true, disable_editor:true, disable_string:true, use_textarea:true, size: 8, disable_type_chooser:true,textarea_height:80, help: {description: tr("The command which needs to be executed on the remote server."), examples:[{code:"tail -100 /home/nginx/error.log",description:tr("Show last lines of log")},{code:"df -h",description:tr("Show disk usage")},{code:"top -n 1",description:tr("Show CPU usage")},{code:"mysqldump -p --all-databases --result-file=dump.sql",description:tr("Dump mysql databases")}]}}) %>
