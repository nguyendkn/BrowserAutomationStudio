<div class="container-fluid">
	...
	<%= _.template($('#input_constructor').html())({id:"interval", description:tr("Interval (seconds)"), default_selector:"int", disable_string: true, value_number:2, min_number:1, max_number:999999, help: {description: tr("Interval")} }) %>
