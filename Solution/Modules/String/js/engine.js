...
function _words(str){
	...
	var uppercase_letters = 'A-Z' + _non_latin_chars.letters.upper;
	var lowercase_letters = 'a-z' + _non_latin_chars.letters.lower;
	var number_chars = '0-9' + _non_latin_chars.numbers;
