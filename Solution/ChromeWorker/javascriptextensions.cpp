    ...
    if(IsRecord)
    {
        ...
        "{"
            ...
            "{"
                ...
                "if(el.tagName.toLowerCase()=='a'){element_type='link'; element_url = el.getAttribute('href'); if(!element_url)element_url='';};"
                "if(el.tagName.toLowerCase()=='img'){element_type='media'; element_url = el.getAttribute('src'); if(!element_url)element_url='';}"
            "}"
