...
<%= _.template($('#input_constructor').html())({id:"string", description: tr("String"), default_selector: "string", value_string: "", help: {description: tr("The string to insert the substring into."),examples:[{code:tr("Just sample text")},{code:"Test text"},{code:"string"}]} }) %>
